<script setup>
	...
	const { controlForm, dataList, clearData, setParams, isDisable } = paramsRSSetting(props, emit)
</script>
					...
					<el-col :span="4">
						<div class="fullDom c-center">
							<div
								...
								@click="setParams(data.value1, data.value2, data.value3)"
							></div>
						</div>
					</el-col>
				</el-row>
