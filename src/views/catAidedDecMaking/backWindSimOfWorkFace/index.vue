<!--工作面反风模拟-->
<script setup>
	import LoadBackWindPlaneMap from '@/views/catAidedDecMaking/backWindSimOfWorkFace/loadBackWindPlaneMap.vue'
	import { backWindSimOfWorkFace } from '@/api/request/catAidedDecMaking/backWindSimOfWorkFace'

	const { windList, windStatusList, windowStatusList } = backWindSimOfWorkFace()
</script>

<template>
	<div class="back_wind_body">
		<div class="fullDom">
		...
		<div class="back_wind_body_right">
			...
			<div class="back_wind_body_right_l6 fullDom">
				<template v-for="item in windowStatusList">
					...
					<span>开度为{{ item.value }}%</span>
				</template>
			</div>
			<div class="back_wind_body_right_l7 fullDom">
				<div class="back_wind_body_btn_green">
					<span>一键通风</span>
				</div>
				<div class="back_wind_body_btn_blue">
					<span>正常通风</span>
				</div>
			</div>
		</div>
...
<style scoped lang="scss">
	@import '@/assets/styles/catAidedDecMaking/backWindSimOfWorkFace';
</style>
